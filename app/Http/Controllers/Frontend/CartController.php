...
class CartController extends Controller
{
    ...
    function viewCart (){
        ...
        $carts = Cart::with('product:id,slug,title,feutured_img,price,selling_price')->where('customer_id', auth('customer')->id())->get();
        // dd($carts);
    ...
    function updateCart(Request $request){
        foreach($request->qty as $product_id=>$qty){
          $cart = Cart::where('product_id', $product_id)->where('customer_id', auth('customer')->id())->first();
