...
.mainmenu > .menu-item-has-children .axil-submenu li{
    ...
    .mainmenu > .menu-item-has-children .axil-submenu li .axil-submenu{
        top: 0 !important;
        left: 100% !important;
        opacity: 0;
    }

    .mainmenu > .menu-item-has-children .axil-submenu li:hover .axil-submenu{
        opacity: 1;
    }
                            ...
                            <ul class="mainmenu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="axil-submenu">
                                        ...
                                        <li><a href=" {{ route("product.category" , $category->slug) }} "> {{ str($category->categoryName)->headline() }} </a>
        ...
        <div class="card-header">
            <form action="index-1.html#">
                <div class="input-group">
                    <input type="search" class="form-control" name="prod-search" id="product-search" placeholder="Write Something....">
 ...
 $('#product-search').keyup(function(){
    ...
    if(search.length > 3){
        $.ajax({
            ...
            success:function({products,count}){
             $('.search-result-header').show()
             $(".search-result-header .title span").html(count);
             ...
             products.forEach(product => {
                ...
                let html = `  <div class="axil-product-list">
                    <div class="thumbnail">
                        <a href="${productUrl}">
                            <img width="80px" src="{{asset('storage/')}}/${product.feutured_img}" alt="${product.title}">
                        </a>
                    </div>
                    <div class="product-content">
                    
                        <h6 class="product-title"><a href="${productUrl}">${product.title}</a></h6>
                        ${product.selling_price ? `<div class="product-price-variant">
             ...
             $('.psearch-results').html(productList)
