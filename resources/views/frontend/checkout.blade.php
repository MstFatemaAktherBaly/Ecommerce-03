                        ...
                        <div class="col-lg-6">
                            <div class="axil-checkout-billing">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name" placeholder="John" value="{{auth('customer')->user()->last_name ?? null}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="address1" class="mb--15" placeholder="House number and street name">
                                    <input type="text" name="secondary_address" id="address2" placeholder="Apartment, suite, unit, etc. (optonal)">
                                </div>
                                <div class="form-group">
                                        ...
                                        <tbody>
                                           ...
                                           @endphp
                                            ...
                                            <tr class="order-total">
                                                <td>Total</td>
                                                <td class="order-total-amount">{{$total}}Tk
