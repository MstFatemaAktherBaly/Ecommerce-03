                                ...
                                <div class="col-lg-10 order-lg-2">
                                    <div class="single-product-thumbnail-wrap zoom-gallery">
                                        <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                            ...
                                            <div class="thumbnail">
                                                <a href=" {{asset('storage/' . $product->feutured_img )}} " class="popup-zoom">
                                                    <img src=" {{asset('storage/' . $product->feutured_img)}} " alt="Product Images">
                                                </a>
                                            </div>
                                             @endif

                                             @if ($product->gallaries && count($product->gallaries) > 0 )
                                             @foreach ( $product->gallaries as $image )
                                             <div class="thumbnail">
                                ...
                                <div class="col-lg-2 order-lg-1">
                                    <div class="product-small-thumb-3 small-thumb-wrapper">
                                        ...
                                        <div class="small-thumb-img">
                                            <img src="{{asset('storage/' . $product->feutured_img )}}" alt="thumb image">
                                        </div>
                                        @endif
                                        @if ($product->gallaries && count($product->gallaries) > 0 )
                                        @foreach ( $product->gallaries as $image )
                        ...
                        <div class="col-lg-5 mb--40">
                            <div class="single-product-content">
                                <div class="inner">
                                    ...
                                    <span class="price-amount"> {{$product->selling_price  ?? null }} tk - <strike>{{$product->price}}</strike> tk </span>
                                    @else
                                ...
                                @endphp
                                    ...
                                    <ul class="product-meta">
                                        <li class=" {{ $product->stock ? '' : 'text-danger' }} ">
                                        ...
                                        <div class="product-action-wrapper d-flex-center">
                                            ...
                                            <ul class="product-action d-flex-center mb--0">
                                                <li class="add-to-cart">
                                                    <button style="width:fit-content; display:inline-block"  class="axil-btn btn-bg-primary" >Add to Cart</button>
                                                </li>
